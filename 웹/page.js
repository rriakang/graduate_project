      ...
      db.query(`SELECT * FROM user ORDER BY id desc, id LIMIT ? OFFSET ?`, [numPerPage, offs], (error, results) => {
        ...
        while (i < results.length) {
          table += `
              ...
              <td class="border-end"><button type="button" class="btn btn-outline-success">
              <a href='/userManage/userUpdate/${results[i].id}' class="link-secondary" style="text-decoration: none;">사용자 정보 수정</a></button></td>
              <td class="border-end"><button type="button" class="btn btn-outline-success">
              <a href='/userManage/userDelete_process/${results[i].id}' onclick="return confirm('사용자를 탈퇴 시키겠습니까??');" class="link-secondary" 
              style="text-decoration: none;">사용자 계정 탈퇴</a></button></td>
              <td class="border-end"><button type="button" class="btn btn-outline-success">
              <a href='/userManage/userMonitoring/${results[i].id}' class="link-secondary" style="text-decoration: none;">사용자 모니터링</a></button></td>
              </tr>
              `
          i++;
        }
